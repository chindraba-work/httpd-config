...
-  Insert your own copyright line(s) after the existing ones, if any
  ...
  [DCO]: https://github.com/chindraba-work/httpd-config/blob/master/docs/DCO
  [LMD]: https://github.com/chindraba-work/httpd-config/blob/master/LICENSE
  ...
  [issue]: https://github.com/chindraba-work/httpd-config/issues
  [pull]: https://github.com/chindraba-work/httpd-config/pulls
